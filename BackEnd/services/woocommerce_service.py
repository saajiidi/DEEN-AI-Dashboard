        ...
        while True:
            ...
            for p in products:
                ...
                all_products.append({
                    ...
                    "Name": p.get("name"),
                    "SKU": p.get("sku"),
                    "Date Created": p.get("date_created", "").replace("T", " ") if p.get("date_created") else None,
                    "Date Modified": p.get("date_modified", "").replace("T", " ") if p.get("date_modified") else None,
                    ...
                    try:
                        ...
                        for v in variations:
                            ...
                            var_list.append({
                                ...
                                "Name": var_name,
                                "SKU": v.get("sku"),
                                "Date Created": v.get("date_created", "").replace("T", " ") if v.get("date_created") else None,
                                "Date Modified": v.get("date_modified", "").replace("T", " ") if v.get("date_modified") else None,
